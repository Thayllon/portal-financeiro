...
[Route("api/v{version:apiVersion}/categorias/receita")]
[Authorize]
public class CategoriasReceitaController : BaseController
{
    private readonly ICategoriaReceitaAppService _service;

    public CategoriasReceitaController(ICategoriaReceitaAppService service)
    {
        _service = service;
    }

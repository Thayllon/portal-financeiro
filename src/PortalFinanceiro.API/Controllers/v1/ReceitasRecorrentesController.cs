...
[Route("api/v{version:apiVersion}/receitas-recorrentes")]
[Authorize]
public class ReceitasRecorrentesController : BaseController
{
    private readonly IReceitaRecorrenteAppService _service;

    public ReceitasRecorrentesController(IReceitaRecorrenteAppService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Criar([FromBody] ReceitaRecorrenteRequest request, [FromQuery] Guid idUsuario)
    {

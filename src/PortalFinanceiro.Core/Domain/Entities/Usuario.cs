...
public class Usuario
{
    ...
    public static Result<Usuario> Criar(string nome, string email, string senhaHash, bool isAdmin = false)
    {
    ...
    public Result<Unit> Atualizar(string nome, string email, string? senhaHash, bool isAdmin, bool ativo)
    {
        if (string.IsNullOrWhiteSpace(nome))
            return Erro.Validacao("NOME_OBRIGATORIO", "Nome é obrigatório.");
        if (string.IsNullOrWhiteSpace(email))

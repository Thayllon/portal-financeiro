...
public class DespesaRecorrente
{
    ...
    public static Result<DespesaRecorrente> Criar(Guid idUsuario, string descricao, decimal valor, int dia, bool diaUtil, Guid idCategoria, Guid idConta, DateTime dataInicio, DateTime? dataFim)
    {

...
public class RegraReceita
{
    ...
    public static Result<RegraReceita> Criar(Guid idUsuario, string descricao, decimal valor, int dia, bool diaUtil, Guid idCategoria, Guid idConta, DateTime dataInicio, DateTime dataFim)
    {

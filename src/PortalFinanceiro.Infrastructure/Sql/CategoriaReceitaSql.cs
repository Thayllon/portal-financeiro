...
internal static class CategoriaReceitaSql
{
    static string T => $"{SqlDialect.Current.SchemaPrefix}CategoriaReceita";
    ...
    public static string ListarAtivas => $"SELECT {C} FROM {T} WHERE Ativo = 1 ORDER BY Nome";

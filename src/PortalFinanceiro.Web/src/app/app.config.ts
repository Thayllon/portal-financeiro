...
LucideBuilding, LucideMinus, LucideUserPen, LucideHandHelping, LucideBanknoteArrowUp, LucideBanknoteArrowDown, LucideBriefcaseBusiness, LucideChevronUp, LucideHome,
  } from '@lucide/angular';

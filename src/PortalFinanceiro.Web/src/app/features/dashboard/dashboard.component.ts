...
@Component({
    ...
    <div class="page">
      <header class="page__header">
        <div class="page__header-left">
          <svg lucideIcon="layout-dashboard" class="page__icon" [size]="22" />
          ...
          <div class="card">
            <div class="card-header">
              <div class="card-icon card-icon--green">
                <svg lucideIcon="trending-up" [size]="20" />
              </div>
          ...
          <div class="card">
            <div class="card-header">
              <div class="card-icon card-icon--red">
                <svg lucideIcon="trending-down" [size]="20" />
              </div>
          ...
          <div class="card">
            <div class="card-header">
              <div class="card-icon card-icon--warning">
                <svg lucideIcon="dollar-sign" [size]="20" />
              </div>
              <span class="card-label">Saldo realizado</span>
            </div>
  ...
  styles: [`
    ...
    .card-icon--green { background: var(--color-success-bg); color: var(--color-success); }
    .card-icon--red { background: var(--color-error-bg); color: var(--color-error); }
    .card-icon--primary { background: var(--color-primary-tint); color: var(--color-primary); }
    .card-icon--warning { background: var(--color-warning-bg); color: var(--color-warning); }
    .card-label { font-size: 0.8125rem; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.03em; font-weight: 500; }
    .card-value { font-size: 1.5rem; font-weight: 700; color: var(--text-primary); margin-bottom: 0.25rem; }
    .card-value.green { color: var(--color-success); }
    .card-value.red { color: var(--color-error); }
    .card-sub { font-size: 0.75rem; color: var(--text-muted); display: flex; gap: 0.5rem; align-items: center; }
    ...
    .table-card { background: var(--content-surface); border: 1px solid var(--surface-border); border-radius: var(--radius-xl); overflow: hidden; }
    ...
    @media (max-width: 767px) {
      ...
      .table td { display: flex; justify-content: space-between; align-items: center; padding: 0.5rem 1rem; border-bottom: 1px solid var(--surface-border); }

    ...
    <div class="page">
      ...
      @if (tabAtiva() === 'mensal') {
        <div class="mensal-header">
          ...
          <div class="totals">
            <span class="total" style="font-size:1.25rem;font-weight:700">{{ totalDespesas() | currencyBRL }}</span>
            <span class="realizado" style="color:var(--color-success);font-size:0.875rem">{{ totalPago() | currencyBRL }} pago</span>
